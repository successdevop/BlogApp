  ...
  return (
    <div>
      <div className="bg-[#F4F0F8] py-[8rem]">
        ...
        <p className="text-[#232536] text-center text-[1.6rem] leading-[2.8rem] opacity-60">
      ...
      <div className="max-w-[76.8rem] mx-auto p-4 grid gap-[3.2rem] lmd:mt-[12rem] mt-[6rem]">
        <div className="grid gap-[3.2rem]">
          ...
          <p className="text-[#4C4C4C] text-[1.6rem] leading-[2.8rem]">
        ...
        <div className="grid gap-[2.4rem]">
          <h3 className="max-w-[71.4756rem] text-[#232536] font-Sen text-[3.6rem] font-bold leading-[4.8rem] tracking-[.-2rem]">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor.
          </h3>
          <p className="text-[#4C4C4C] text-[1.6rem] leading-[2.8rem]">

    ...
    <div>
      ...
      <form className="flex flex-col md:mx-[21rem] mx-[2rem] mt-[2rem] ">
        <input
          ...
          id=""
          className=" text-[#232536]text-base leading-7 whitespace-nowrap border w-full px-5 py-6 rounded-sm border-solid border-zinc-500 border-opacity-50 max-md:max-w-full max-md:pl-1 placeholder-bold"
        />

        <input
          className="text-gray-800 text-base leading-7 whitespace-nowrap border w-full mt-4 px-5 py-6 rounded-sm border-solid border-zinc-500 border-opacity-50 max-md:max-w-full max-md:pl-1 placeholder-bold"
